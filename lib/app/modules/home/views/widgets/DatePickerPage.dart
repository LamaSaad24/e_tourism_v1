import 'package:e_tourism/app/modules/home/views/widgets/SearchByDaterPage.dart';
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => SearchByDaterPage(
            ...
            child: Text('عرض الرحلات', style: TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
